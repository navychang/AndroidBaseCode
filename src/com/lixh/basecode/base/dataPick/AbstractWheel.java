...
public abstract class AbstractWheel extends View {
	...
	/**
	 * Returns base dimension of the spinnerwheel ¡ª width for horizontal
	...
	/**
	 * Returns base dimension of base item ¡ª width for horizontal spinnerwheel,
	 * height for vertical
	 * 
	...
	/**
	 * Processes MotionEvent and returns relevant position ¡ª x for horizontal
	...
	private boolean addItemView(int index, boolean first) {
		...
		view.setBackgroundResource(R.drawable.dialog_shape_buttom_line);
		if (view != null) {
			if (first) {
