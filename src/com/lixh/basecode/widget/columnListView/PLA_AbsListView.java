...
public abstract class PLA_AbsListView extends PLA_AdapterView<ListAdapter>
	...
	protected float getTopFadingEdgeStrength() {
		...
		if (count == 0) {
			...
			// fadeLength : fadeEdge;
			return top < getPaddingTop() ? -(top - getPaddingTop())
					/ fadeLength : fadeEdge;
		}
	}
	...
	protected float getBottomFadingEdgeStrength() {
		...
		if (count == 0) {
			...
			return bottom > height - getPaddingBottom() ? (bottom - height + getPaddingBottom())
					/ fadeLength
					: fadeEdge;
		}
	}
	 ...
	 *            recycler.
	 * 
	 * @see com.lixh.basecode.widget.columnListView.PLA_AbsListView.RecycleBin
