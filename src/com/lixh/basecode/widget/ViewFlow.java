 ...
 * 
 * private ViewFlow viewFlow; viewFlow.setAdapter(new ImageAdapter(this));
 * viewFlow.setmSideBuffer(2);
 * 
 * CircleFlowIndicator indic = (CircleFlowIndicator)
 * findViewById(R.id.viewflowindic); viewFlow.setFlowIndicator(indic);
 * viewFlow.setTimeSpan(4500); viewFlow.setSelection(2 * 1000); // 设置初始位置
 ...
 *           sl.requestDisallowInterceptTouchEvent(false); else
